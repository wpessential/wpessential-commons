...
class Str
{
	...
	{
		if ( ! $result = wpe_array_reduce_allow_str( is_array( $defaults ) ? $defaults : $classes ) )
		{
	 ...
	 * @return bool
	 */
	public static function blank ( ?string $string )
	{
	 ...
	 * @return bool
	 */
	public static function starts ( $needle, $haystack )
	{
		if ( ! $needle )
		{
			return true;
	...
	public static function pregMatchFindFirst ( array $patterns, string $subject )
	{
		...
		{
			if ( $reg = is_string( $pattern ) ? $pattern : wpe_array_walk( [ 'regex' ], $pattern ) )
			{
				$regex[] = $reg . '(*MARK:' . $i . ')';
			}
		}
	 ...
	 * @return string
	 */
	public static function limit ( string $string, int $limit, string $end = '' )
	{
	 ...
	 * @return int
	 */
	public static function length ( $string, ?string $encoding = null )
	{
		if ( $encoding )
		{
	 ...
	 * @return bool
	 */
	public static function maxed ( $string, int $max, ?string $encoding = null )
	{
	 ...
	 * @return bool
	 */
	public static function min ( $string, int $min, ?string $encoding = null )
	{
	 ...
	 * @return string
	 */
	public static function encoding ( ?string $encoding = null )
	{
